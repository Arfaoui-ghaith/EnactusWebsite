@extends('layouts.app', ['activePage' => 'tablette', 'titlePage' => __('tablette Management')])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('tablette.store') }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('post')

            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Add tablette Model') }}</h4>
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  <div class="col-md-12 text-right">
                      <a href="{{ route('BrandTab.show', $brandtab) }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    ...
                    @foreach ($brandstabmenu as $brand)
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-primary">{{ __('Add tablette Model') }}</button>
              </div>
            </div>
          </form>
        </div>
