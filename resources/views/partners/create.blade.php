...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('partner.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
            ...
            <div class="card ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('image') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" name="image" id="input-image" type="text"   aria-required="true"/>
                      @if ($errors->has('image'))
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-primary">{{ __('Add Partner') }}</button>
              </div>
            </div>
          </form>
        </div>
