                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('first_title') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('first_title') ? ' is-invalid' : '' }}" name="first_title" id="input-first_title" type="text"  value="{{ $project->first_title }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" id="input-title" type="text"  value="{{ $project->title }}" required="true" aria-required="true"/>
                      @if ($errors->has('title'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                      <textarea class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" id="input-description" placeholder="{{ $project->description }}"  value="{{ $project->description }}" required="true" rows="6" aria-required="true"/>{{ $project->description }}</textarea>
               ...
               <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('goals') ? ' has-danger' : '' }}">
                      <textarea class="form-control{{ $errors->has('goals') ? ' is-invalid' : '' }}" name="goals" id="input-goals" placeholder="{{ $project->goals }}"  value="{{ $project->goals }}" required="true" rows="6" aria-required="true"/>{{ $project->goals }}</textarea>
                      @if ($errors->has('goals'))
