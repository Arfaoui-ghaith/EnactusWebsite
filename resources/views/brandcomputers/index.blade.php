        ...
        <div class="card card-plain">
          ...
          <div class="card-body">
            ...
            <div class="col-12 text-right">
                    <a href="{{ route('BrandComputer.create') }}" class="btn btn-sm btn-primary">{{ __('Add New Brand') }}</a>
                  </div>
                </div>
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                  @foreach($BrandComputers as $brand)
                  <tr>
                    <td>
                      {{ $brand->id }}
                    </td>
                    ...
                    <td class="td-actions text-right">
                        <form action="{{ route('BrandComputer.destroy', $brand) }}" method="post">
                                  @csrf
                                  @method('delete')
                              
                                  <a rel="tooltip" class="btn btn-success btn-link" href="{{ route('BrandComputer.edit', $brand) }}" data-original-title="" title="">
